...
const Events = () => {
  return (
    <section id="events" className="w-full py-12 md:py-24 lg:py-32 bg-opacity-30 backdrop-blur-lg bg-gray-300 shadow-lg  border border-opacity-20 border-white rounded-md ">
